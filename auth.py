...
def get_user_notifications(limit=10):
    ...
    try:
        ...
        # If table doesn't exist or has issues, return empty list
        return []
...
def mark_notification_read(notification_id):
    ...
    try:
        ...
        # If is_read column doesn't exist yet, silently fail
        pass
    ...
    try:
        with get_db_connection() as conn:
            ...
            cursor.execute("""
                ...
                WHERE recipient_id = %s AND (is_read = FALSE OR is_read IS NULL)
            """, (user['employee_id'],))
            return cursor.fetchone()['cnt']
    except Exception:
        # If is_read column doesn't exist yet, return 0
        # This handles the case before migration runs
        return 0
