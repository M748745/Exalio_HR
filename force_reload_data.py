"""
FORCE RELOAD - Delete old data and load complete SQLite export
"""
...
def force_reload():
    print("=" * 60)
    print("FORCE RELOADING DATABASE WITH COMPLETE DATA")
    print("=" * 60)
    ...
    try:
        with get_db_connection() as conn:
            ...
            # Load complete data
            print("\n2. Loading complete SQLite data...")
            ...
            -- Users (9 rows) - passwords: admin123, manager123, emp123, testpass
            ...
            cursor.execute(complete_data_sql)
            conn.commit()
